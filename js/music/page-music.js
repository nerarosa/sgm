var dblisturl = "http://sgmmusic-list.blogspot.com";
...
/*FWDMSPUtils.onReady(function(){
	new FWDMSP({
		...
		popupWindowHeight:392
	});
});*/
	
FWDRLUtils.onReady(function(){
	var urlfeed = 'https://sexygirlmedia.blogspot.com/feeds/posts/default/-/Photo?alt=json-in-script&orderby=updated&max-results=55';
	$.ajax({
		url: urlfeed,
		type: 'get',
		async: true,
