...
if(link != '' && link != undefined && link != null){
	...
	if(svRun != ''){	
		function videoSetup(infoVideo){
			...
			videojs('ssgirl-videojs').ready(function () {
				...
				player.on('loadedmetadata', function() {
					...
					if(isMobile == false){
						var contentads = '<div><a href="http://www.facebook.com/cvnphotoblog" target="_blank"><img src="https://lh3.googleusercontent.com/-PXLkB5DvQO4/Vq00g6Log9I/AAAAAAAACmQ/8tSxWLshtPk/s0-Ic42/sgm468x60.jpg"/></a></div>';
					}else{			
						var contentads = '<div><a href="http://www.facebook.com/cvnphotoblog" target="_blank"><img src="https://lh3.googleusercontent.com/-jvkiPdK3STs/Vq0w40f59XI/AAAAAAAACl8/FD_YPjZtG1M/s0-Ic42/sgm300x50.jpg"/></a></div>';
					}
		...
		if(svRun == 'P'){
			...
			})("http://showsexygirl.zz.mu/sgm/sgmvideo.php");
	...
	$("#player-wrapper").html($('.main-post-content'));
				...
				document.location="http://sexygirlmedia.blogspot.com/404.html";
			}
	});