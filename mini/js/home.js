			...
			if(data == "effFeed"){
				...
				if(entry !== undefined){
					...
					for(var i = 0; i < entry.length; i++){						
						...
						itemEmbed += '<div class="col-xs-12 col-sm-6 col-md-6"><div class="gp_products_inner"><div class="gp_products_item_image"><a href="'+ urlPost +'"><img class="lazyload" data-original="'+ thumbPost +'" alt="'+ titlePost +'" /></a></div><div class="gp_products_item_caption"><ul class="gp_products_caption_name"><li><a href="'+ urlPost +'">'+ titlePost +'</a></li><li><a href="#">'+ datePost +'</a></li></ul></div></div></div>';
