...
function sgmSearch(d){function v(a){var h=$("#grid-gallery").find(".content-box"),m;var e=Math.floor(a/300);var b=a-293*e;if(0<b){1===e&&150>b||(e+=1);var g=Math.floor(a/e)-7;a=300/g;b=0;for(m=h.length;b<m;b+=1){var c=$(h[b]).data("col");var f=$(h[b]).data("row");var d=g;1<c&&1<e&&(d=(g+7)*c-7);$(h[b]).width(d).find("img").width(d);$(h[b]).width(d).find(".no-color").width(d);c=1===e?"auto":(Math.floor(186/a)+7)*f-7;$(h[b]).height(c).find("img").height(c);$(h[b]).width(d).find(".no-color").height(c)}}return g+
7}function z(){A($(this).find(".content-box-text"),1)}function B(){isMobile||C($(this).find(".content-box-text"),0)}function A(a,h){h=h||1;a.stop().animate({opacity:1},function(){a.animate({opacity:h},0)})}function C(a,h){a.stop().animate({opacity:h},function(){a.animate({opacity:h},0)})}var f=this,u=$("input#morphsearchInput").val().trim(),q=$("#category").val(),t=$("#country").val(),x=$("#postGroup").val(),y=$("#stt").val(),p="";0!=q&&(p+="/"+q);0!=t&&(p+="/"+t);0!=x&&(p+="/"+x);0!=y&&(p+="/"+y);
q=void 0===d?""==p?url_blog+"feeds/posts/summary?alt=json-in-script&max-results=200":url_blog+"feeds/posts/summary/-"+p+"?alt=json-in-script&max-results=200":d;$("b#search-string").html(u);""!==u&&$.ajax({type:"get",url:q,cache:!1,dataType:"jsonp",beforeSend:function(){$(".advance-search-loading").fadeIn()},success:function(a){f.analyzeData(a)},error:function(){$("#grid-gallery").html('<strong id="error-result">L\u1ed7i load d\u1eef li\u1ec7u</strong>')},complete:function(){$(".advance-search-loading").fadeOut()}});
f.analyzeData=function(a){var h="",m="",e="",b="",g="",c="",k="",q="",n="";h=a.feed.entry;e=a.feed.link;for(a=0;a<e.length;a++)"next"==e[a].rel?(n=e[a].href,n=""==p?url_blog+"feeds/posts/summary?"+n.split("?")[1]:url_blog+"feeds/posts/summary/-"+p+"?"+n.split("?")[1],$("#advance-search-page").html('<span id="next-link" data-url-next="'+n+'">Load More</span>')):$("#advance-search-page").html("");if(void 0!==h){var l=u;0==$("#cb6").is(":checked")&&(l=f.change_alias(l));for(a=0;a<h.length;a++){c=f.executeData(h[a]);
e=c.link;b=c.title;k=c.thumbimg;g=c.sum;c=c.type;if(0==$("#cb6").is(":checked")){var r=f.change_alias(b);g=f.change_alias(g)}else r=b;if(1==$("#cb7").is(":checked")){if(f.regExp(g,l)||f.regExp(r,l))m+=f.printResultItem(e,k,b,c)}else if(f.regExp(r,l)||f.regExp(l,r))m+=f.printResultItem(e,k,b,c)}if(""===m&&0==$("#cb7").is(":checked")&&0==$("#cb6").is(":checked")&&-1!=l.indexOf(" ")){l=l.split(" ");for(a=0;a<h.length;a++)for(c=f.executeData(h[a]),e=c.link,b=c.title,k=c.thumbimg,g=c.sum,c=c.type,0==$("#cb6").is(":checked")?
(r=f.change_alias(b),g=f.change_alias(g)):r=b,g=0;g<l.length;g++)f.regExp(r,l[g])&&(m+=f.printResultItem(e,k,b,c));""!==m&&(q='Kh\u00f4ng t\u00ecm th\u1ea5y k\u1ebft qu\u1ea3 v\u1edbi "'+u+'". K\u1ebft qu\u1ea3 thay th\u1ebf v\u1edbi c\u00e1c t\u1eeb : '+l)}}if(""!==m){$("h4#results-text-change").html(q);if(void 0===d){$("#grid-gallery").html(m);var w=0}else 0<$("#no-result").length&&$("#no-result").remove(),w=$("#grid-gallery").find(".content-box").length-1,$("#grid-gallery").append(m);var t=$("#grid-gallery").find(".content-box");
$("#advance-search-page").fadeIn();void 0===d&&$("#grid-gallery").masonry2({itemSelector:".content-box",isAnimated:!0,columnWidth:v});$("#grid-gallery").imagesLoaded(function(){var a=w,b;$("#grid-gallery").masonry2("reload").trigger("itemsLoaded");var c=function(a){$(t[a]).css({opacity:0,visibility:"visible",marginTop:100}).animate({opacity:1,marginTop:0},300,function(){a===b-1&&$("#grid-gallery").masonry2("reload")})};a=w;for(b=t.length;a<b;a+=1)(function(a){window.setTimeout(function(){c(a)},100*
a)})(a)});$("#grid-gallery").on("mouseenter",".content-box",z);$("#grid-gallery").on("mouseleave",".content-box",B)}else void 0===d?0==$("#advance-search-page").length?($("#grid-gallery").html('<div id="no-result">Kh\u00f4ng t\u00ecm th\u1ea5y k\u1ebft qu\u1ea3 n\u00e0o</div>'),""!==$("h4#results-text-change").html()&&$("h4#results-text-change").html("")):""!=n?sgmSearch(n):$("ul#og-grid a"):""!=n?sgmSearch(n):0==$("#grid-gallery a").length&&($("#grid-gallery").html('<div id="no-result">Kh\u00f4ng t\u00ecm th\u1ea5y k\u1ebft qu\u1ea3 n\u00e0o</div>'),
""!==$("h4#results-text-change").html()&&$("h4#results-text-change").html(""))};f.change_alias=function(a){a=a.toLowerCase();a=a.replace(/\u00e0|\u00e1|\u1ea1|\u1ea3|\u00e3|\u00e2|\u1ea7|\u1ea5|\u1ead|\u1ea9|\u1eab|\u0103|\u1eb1|\u1eaf|\u1eb7|\u1eb3|\u1eb5/g,"a");a=a.replace(/\u00e8|\u00e9|\u1eb9|\u1ebb|\u1ebd|\u00ea|\u1ec1|\u1ebf|\u1ec7|\u1ec3|\u1ec5/g,"e");a=a.replace(/\u00ec|\u00ed|\u1ecb|\u1ec9|\u0129/g,"i");a=a.replace(/\u00f2|\u00f3|\u1ecd|\u1ecf|\u00f5|\u00f4|\u1ed3|\u1ed1|\u1ed9|\u1ed5|\u1ed7|\u01a1|\u1edd|\u1edb|\u1ee3|\u1edf|\u1ee1/g,
"o");a=a.replace(/\u00f9|\u00fa|\u1ee5|\u1ee7|\u0169|\u01b0|\u1eeb|\u1ee9|\u1ef1|\u1eed|\u1eef/g,"u");a=a.replace(/\u1ef3|\u00fd|\u1ef5|\u1ef7|\u1ef9/g,"y");return a.replace(/\u0111/g,"d")};f.regExp=function(a,h){return(new RegExp(h,"i")).test(a)};f.printResultItem=function(a,h,d,e){var b;if("video"==e||"photo"==e||"story"==e||"radio"==e)var g=b=1;else if("wallpaper"==e)g=b=2;else if("book"==e||"audiobook"==e||"comic"==e)b=1,g=2;switch(e){case "video":var c="Play";break;case "wallpaper":c="Download";
break;case "comic":case "book":c="\u0110\u1ecdc";break;case "radio":case "audiobook":c="Nghe";break;default:c="View"}return'<div class="content-box" data-col="'+b+'" data-row="'+g+'" style="width:300px;"><img src="'+h+'" width="300"/><div class="content-box-content"><div class="content-box-text"><a href="'+a+'" title="'+d+'"><div class="text-wrapper"><h3 class="post-info"></h3><h2>'+d+'</h2></div><div class="view-gallery"><span class="item-num">'+e+'</span><span class="grid-gallery-icon '+e+'"></span><span class="view-text">'+
c+' <span class="more-arrow">\u00bb</span></span></div></a></div></div></div>'};f.executeData=function(a){var d="",f="",e="",b="",g=[],c="";for(f=0;f<a.link.length;f++)"alternate"==a.link[f].rel&&(d=a.link[f].href);f=a.title.$t;e="content"in a?a.content.$t:"summary"in a?a.summary.$t:"";b="media$thumbnail"in a?imageHostFix(a.media$thumbnail.url):"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAMAAAAoyzS7AAAAA1BMVEXMzMzKUkQnAAAACklEQVQI12NgAAAAAgAB4iG8MwAAAABJRU5ErkJggg==";void 0!==a.category&&
$.each(a.category,function(b){g.push(a.category[b].term)});-1!=$.inArray("Photo",g)?(c="photo",b=b.replace("/s72-c/","/w255-h160-c/")):-1!=$.inArray("Video",g)?(c="video",b=b.replace("/s72-c/","/w255-h160-c/")):-1!=$.inArray("Wallpaper",g)?(c="wallpaper",b=b.replace("/s72-c/","/w520-h325-c/")):-1!=$.inArray("ComicFull",g)?(c="comic",b=b.replace("/s72-c/","/w255-h325-c/")):-1!=$.inArray("Book",g)?(c="book",b=b.replace("/s72-c/","/w255-h325-c/")):-1!=$.inArray("AudioBook",g)?(c="audiobook",b=b.replace("/s72-c/",
"/w255-h325-c/")):-1!=$.inArray("Story",g)?(c="story",b=b.replace("/s72-c/","/w255-h160-c/")):-1!=$.inArray("Radio",g)?(c="radio",b=b.replace("/s72-c/","/w255-h160-c/")):(c="other",b=b.replace("/s72-c/","/w250-c/"));e=e.replace(/<\S[^>]*>/g,"");var k={};k.title=f;k.link=d;k.sum=e;k.thumbimg=b;k.type=c;return k};return!1}
$(document).ready(function(){$("input#morphsearchInput").on("keyup",function(d){if(-1!==$.inArray(d.keyCode,[9,13,16,17,18,19,20,27,33,34,35,36,37,38,39,40]))return!1;clearTimeout($.data(this,"timer"));d=$(this).val().trim();$("#grid-gallery").html("");$("#advance-search-page").fadeOut().html("");""==d?($("#grid-gallery").fadeOut(),$("h4#results-text").fadeOut()):1<d.length&&($("#grid-gallery").fadeIn(),$("h4#results-text").fadeIn(),$(this).data("timer",setTimeout(function(){sgmSearch()},100)))});
$("#wrapselect select").change(function(d){clearTimeout($.data(this,"timer"));d=$("input#morphsearchInput").val().trim();$("#grid-gallery").html("");$("#advance-search-page").fadeOut().html("");$("input#morphsearchInput").focus();""==d?($("#grid-gallery").fadeOut(),$("h4#results-text").fadeOut()):1<d.length&&($("#grid-gallery").fadeIn(),$("h4#results-text").fadeIn(),$(this).data("timer",setTimeout(function(){sgmSearch()},100)))});$("#wrapselect input[type=checkbox]").change(function(d){clearTimeout($.data(this,
"timer"));d=$("input#morphsearchInput").val().trim();$("#grid-gallery").html("");$("#advance-search-page").fadeOut().html("");$("input#morphsearchInput").focus();""==d?($("#grid-gallery").fadeOut(),$("h4#results-text").fadeOut()):1<d.length&&($("#grid-gallery").fadeIn(),$("h4#results-text").fadeIn(),$(this).data("timer",setTimeout(function(){sgmSearch()},100)))});$(document).on("click","#advance-search-page span",function(d){d.preventDefault();var v=$(this).data("url-next");clearTimeout($.data(this,
"timer"));$(this).data("timer",setTimeout(function(){sgmSearch(v)},100))});getRecent("Bikini","#recentOverlay");getRecent("Sexy","#recentOverlay1",!0)});
...
error:function(){$("#mix-container").html('<div class="slide"><strong>Error Loading Feed!</strong></div>')}})}$(document).ready(function(){$("#funbutton #trigger-overlay").click(function(){$(this).hasClass("wasLoaded")||(getListStar(),$(this).addClass("wasLoaded"))})});
...
$(document).ready(function(){var a=$("#menu-wrapper").offset().top,b=function(){$(window).scrollTop()>a?$("#menu-wrapper").css({position:"fixed",top:0,left:0,"z-index":99,background:"rgba(0, 0, 0, 0.6)"}):$("#menu-wrapper").css({position:"relative",background:""})};b();$(window).scroll(function(){b()})});$(function(){$(".searchbutton").click(function(){$(this).toggleClass("active");$(".search-form").slideToggle("normal")})});
...
$(function(){$(window).scroll(function(){100<$(this).scrollTop()?$("#BounceToTop").fadeIn():$("#BounceToTop").fadeOut()});$("#BounceToTop").click(function(){$("body, html").animate({scrollTop:0},600).animate({scrollTop:25},200).animate({scrollTop:0},150).animate({scrollTop:0},50)});var a=!1;$("#bt-show-hide-shoutbox").click(function(){a?$("#panel-shoutbox-bottom").stop(!0,!0).animate({bottom:"-530px"},"fast"):$("#panel-shoutbox-bottom").stop(!0,!0).animate({bottom:"0"},"fast");a=!a});a||$("#close-shoutbox").click(function(){$("#panel-shoutbox-bottom").stop(!0,
!0).animate({bottom:"-530px"},"fast")})});