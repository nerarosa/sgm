...
function sgmSearch(r){function y(a){var c=$("#grid-gallery").find(".content-box"),e;var f=Math.floor(a/300);var b=a-293*f;if(0<b){1===f&&150>b||(f+=1);var h=Math.floor(a/f)-7;a=300/h;b=0;for(e=c.length;b<e;b+=1){var d=$(c[b]).data("col");var g=$(c[b]).data("row");var l=h;1<d&&1<f&&(l=(h+7)*d-7);$(c[b]).width(l).find("img").width(l);$(c[b]).width(l).find(".no-color").width(l);d=1===f?"auto":(Math.floor(186/a)+7)*g-7;$(c[b]).height(d).find("img").height(d);$(c[b]).width(l).find(".no-color").height(d)}}return h+
7}function z(){A($(this).find(".content-box-text"),1)}function B(){isMobile||C($(this).find(".content-box-text"),0)}function A(a,c){c=c||1;a.stop().animate({opacity:1},function(){a.animate({opacity:c},0)})}function C(a,c){a.stop().animate({opacity:c},function(){a.animate({opacity:c},0)})}var g=this,v=$("input#morphsearchInput").val().trim();var n=$("#category").val();var u=$("#country").val(),w=$("#postGroup").val(),x=$("#stt").val(),p="";0!=n&&(p+="/"+n);0!=u&&(p+="/"+u);0!=w&&(p+="/"+w);0!=x&&(p+=
"/"+x);n=void 0===r?""==p?url_blog+"feeds/posts/summary?alt=json-in-script&max-results=200":url_blog+"feeds/posts/summary/-"+p+"?alt=json-in-script&max-results=200":r;$("b#search-string").html(v);""!==v&&$.ajax({type:"get",url:n,cache:!1,dataType:"jsonp",beforeSend:function(){$(".advance-search-loading").fadeIn()},success:function(a){g.analyzeData(a)},error:function(){$("#grid-gallery").html('<strong id="error-result">L\u1ed7i load d\u1eef li\u1ec7u</strong>')},complete:function(){$(".advance-search-loading").fadeOut()}});
g.analyzeData=function(a){var c,e,f="",b="",h="",d="",t=e=c="",l="",m="",f=a.feed.entry,h=a.feed.link;for(a=0;a<h.length;a++)"next"==h[a].rel?(m=h[a].href,m=""==p?url_blog+"feeds/posts/summary?"+m.split("?")[1]:url_blog+"feeds/posts/summary/-"+p+"?"+m.split("?")[1],$("#advance-search-page").html('<span id="next-link" data-url-next="'+m+'">Load More</span>')):$("#advance-search-page").html("");if(void 0!==f){var k=v;0==$("#cb6").is(":checked")&&(k=g.change_alias(k));for(a=0;a<f.length;a++){e=g.executeData(f[a]);
h=e.link;d=e.title;t=e.thumbimg;c=e.sum;e=e.type;if(0==$("#cb6").is(":checked")){var q=g.change_alias(d);c=g.change_alias(c)}else q=d;if(1==$("#cb7").is(":checked")){if(g.regExp(c,k)||g.regExp(q,k))b+=g.printResultItem(h,t,d,e)}else if(g.regExp(q,k)||g.regExp(k,q))b+=g.printResultItem(h,t,d,e)}if(""===b&&0==$("#cb7").is(":checked")&&0==$("#cb6").is(":checked")&&-1!=k.indexOf(" ")){k=k.split(" ");for(a=0;a<f.length;a++)for(e=g.executeData(f[a]),h=e.link,d=e.title,t=e.thumbimg,c=e.sum,e=e.type,0==$("#cb6").is(":checked")?
(q=g.change_alias(d),c=g.change_alias(c)):q=d,c=0;c<k.length;c++)g.regExp(q,k[c])&&(b+=g.printResultItem(h,t,d,e));""!==b&&(l='Kh\u00f4ng t\u00ecm th\u1ea5y k\u1ebft qu\u1ea3 v\u1edbi "'+v+'". K\u1ebft qu\u1ea3 thay th\u1ebf v\u1edbi c\u00e1c t\u1eeb : '+k)}}if(""!==b){$("h4#results-text-change").html(l);if(void 0===r){$("#grid-gallery").html(b);var n=0}else 0<$("#no-result").length&&$("#no-result").remove(),n=$("#grid-gallery").find(".content-box").length-1,$("#grid-gallery").append(b);var u=$("#grid-gallery").find(".content-box");
$("#advance-search-page").fadeIn();void 0===r&&$("#grid-gallery").masonry2({itemSelector:".content-box",isAnimated:!0,columnWidth:y});$("#grid-gallery").imagesLoaded(function(){var a=n,b;$("#grid-gallery").masonry2("reload").trigger("itemsLoaded");var c=function(a){$(u[a]).css({opacity:0,visibility:"visible",marginTop:100}).animate({opacity:1,marginTop:0},300,function(){a===b-1&&$("#grid-gallery").masonry2("reload")})};a=n;for(b=u.length;a<b;a+=1)(function(a){window.setTimeout(function(){c(a)},100*
a)})(a)});$("#grid-gallery").on("mouseenter",".content-box",z);$("#grid-gallery").on("mouseleave",".content-box",B)}else void 0===r?0==$("#advance-search-page").length?($("#grid-gallery").html('<div id="no-result">Kh\u00f4ng t\u00ecm th\u1ea5y k\u1ebft qu\u1ea3 n\u00e0o</div>'),""!==$("h4#results-text-change").html()&&$("h4#results-text-change").html("")):""!=m?sgmSearch(m):$("ul#og-grid a"):""!=m?sgmSearch(m):0==$("#grid-gallery a").length&&($("#grid-gallery").html('<div id="no-result">Kh\u00f4ng t\u00ecm th\u1ea5y k\u1ebft qu\u1ea3 n\u00e0o</div>'),
""!==$("h4#results-text-change").html()&&$("h4#results-text-change").html(""))};g.change_alias=function(a){a=a.toLowerCase();a=a.replace(/\u00e0|\u00e1|\u1ea1|\u1ea3|\u00e3|\u00e2|\u1ea7|\u1ea5|\u1ead|\u1ea9|\u1eab|\u0103|\u1eb1|\u1eaf|\u1eb7|\u1eb3|\u1eb5/g,"a");a=a.replace(/\u00e8|\u00e9|\u1eb9|\u1ebb|\u1ebd|\u00ea|\u1ec1|\u1ebf|\u1ec7|\u1ec3|\u1ec5/g,"e");a=a.replace(/\u00ec|\u00ed|\u1ecb|\u1ec9|\u0129/g,"i");a=a.replace(/\u00f2|\u00f3|\u1ecd|\u1ecf|\u00f5|\u00f4|\u1ed3|\u1ed1|\u1ed9|\u1ed5|\u1ed7|\u01a1|\u1edd|\u1edb|\u1ee3|\u1edf|\u1ee1/g,
"o");a=a.replace(/\u00f9|\u00fa|\u1ee5|\u1ee7|\u0169|\u01b0|\u1eeb|\u1ee9|\u1ef1|\u1eed|\u1eef/g,"u");a=a.replace(/\u1ef3|\u00fd|\u1ef5|\u1ef7|\u1ef9/g,"y");return a.replace(/\u0111/g,"d")};g.regExp=function(a,c){return(new RegExp(c,"i")).test(a)};g.printResultItem=function(a,c,e,f){var b;if("video"==f||"photo"==f||"story"==f||"radio"==f)var h=b=1;else if("wallpaper"==f)h=b=2;else if("book"==f||"audiobook"==f||"comic"==f)b=1,h=2;switch(f){case "video":var d="Play";break;case "wallpaper":d="Download";
break;case "comic":case "book":d="\u0110\u1ecdc";break;case "radio":case "audiobook":d="Nghe";break;default:d="View"}return'<div class="content-box" data-col="'+b+'" data-row="'+h+'" style="width:300px;"><img src="'+c+'" width="300"/><div class="content-box-content"><div class="content-box-text"><a href="'+a+'" title="'+e+'"><div class="text-wrapper"><h3 class="post-info"></h3><h2>'+e+'</h2></div><div class="view-gallery"><span class="item-num">'+f+'</span><span class="grid-gallery-icon '+f+'"></span><span class="view-text">'+
d+' <span class="more-arrow">\u00bb</span></span></div></a></div></div></div>'};g.executeData=function(a){for(var c="",e="",f="",b="",h=[],d="",e=0;e<a.link.length;e++)"alternate"==a.link[e].rel&&(c=a.link[e].href);e=a.title.$t;f="content"in a?a.content.$t:"summary"in a?a.summary.$t:"";b="media$thumbnail"in a?a.media$thumbnail.url:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAMAAAAoyzS7AAAAA1BMVEXMzMzKUkQnAAAACklEQVQI12NgAAAAAgAB4iG8MwAAAABJRU5ErkJggg==";void 0!==a.category&&$.each(a.category,
function(b){h.push(a.category[b].term)});-1!=$.inArray("Photo",h)?(d="photo",b=b.replace("/s72-c/","/w255-h160-c/")):-1!=$.inArray("Video",h)?(d="video",b=b.replace("/s72-c/","/w255-h160-c/")):-1!=$.inArray("Wallpaper",h)?(d="wallpaper",b=b.replace("/s72-c/","/w520-h325-c/")):-1!=$.inArray("ComicFull",h)?(d="comic",b=b.replace("/s72-c/","/w255-h325-c/")):-1!=$.inArray("Book",h)?(d="book",b=b.replace("/s72-c/","/w255-h325-c/")):-1!=$.inArray("AudioBook",h)?(d="audiobook",b=b.replace("/s72-c/","/w255-h325-c/")):
-1!=$.inArray("Story",h)?(d="story",b=b.replace("/s72-c/","/w255-h160-c/")):-1!=$.inArray("Radio",h)?(d="radio",b=b.replace("/s72-c/","/w255-h160-c/")):(d="other",b=b.replace("/s72-c/","/w250-c/"));var f=f.replace(/<\S[^>]*>/g,""),g={};g.title=e;g.link=c;g.sum=f;g.thumbimg=b;g.type=d;return g};return!1};
...
function getListStar(){$.ajax({url:ssgirlData+"/feeds/posts/summary?alt=json-in-script&max-results=200",type:"get",dataType:"jsonp",success:function(c){var g='<div class="fail-message"><span>Kh\u00f4ng c\u00f3 k\u1ebft qu\u1ea3 n\u00e0o.</span></div>',h="Ng\u01b0\u1eddi m\u1eabu;Ca s\u0129;Di\u1ec5n vi\u00ean;H\u00e0n Qu\u1ed1c;Nh\u1eadt B\u1ea3n;Vi\u1ec7t Nam;Th\u00e1i Lan;Trung Qu\u1ed1c;\u00c2u M\u0129".split(";"),m="model singer actress kr jp vn tl cn en-us".split(" "),d=c.feed.entry;if(void 0!==
d){for(var e=0,n=d.length;e<n;e++){var k=d[e].title.$t;var p=d[e].id.$t.split("post-")[1];var l="";c=d[e].category;for(var f=0;f<c.length;f++)-1<$.inArray(c[f].term,h)&&(l+=" "+m[h.indexOf(c[f].term)]);g+='<div class="mix'+l+'" data-abcorder="'+k+'"><a href="'+url_blog+"search?q="+p+'&d=ssgirl" >'+k+"</a></div>"}$("#mix-container").html(g);""!==$("#mix-container").html()&&({$filters:null,$reset:null,groups:[],outputArray:[],outputString:"",init:function(){var a=this;a.$filters=$(".control-bar");
a.$reset=$("#Reset");a.$container=$("#mix-container");a.$filters.find("div.ft").each(function(){a.groups.push({$buttons:$(this).find(".filter"),active:""})});a.bindHandlers()},bindHandlers:function(){var a=this;a.$filters.on("click",".filter",function(b){b.preventDefault();b=$(this);b.hasClass("active")?b.removeClass("active"):b.addClass("active").siblings(".filter").removeClass("active");a.parseFilters()});a.$reset.on("click",function(b){b.preventDefault();a.$filters.find(".filter").removeClass("active");
a.parseFilters()})},parseFilters:function(){for(var a=0,b;b=this.groups[a];a++)b.active=b.$buttons.filter(".active").attr("data-filter")||"";this.concatenate()},concatenate:function(){this.outputString="";for(var a=0,b;b=this.groups[a];a++)this.outputString+=b.active;!this.outputString.length&&(this.outputString="all");console.log(this.outputString);this.$container.mixItUp("isLoaded")&&this.$container.mixItUp("filter",this.outputString)}}.init(),{$sorts:null,groups:[],outputArray:[],outputString:"",
init:function(){var a=this;a.$sorts=$(".control-bar");a.$container=$("#mix-container");a.$sorts.find("div.st").each(function(){a.groups.push({$buttons:$(this).find(".sort"),active:""})});a.bindHandlers()},bindHandlers:function(){var a=this;a.$sorts.on("click",".sort",function(b){b.preventDefault();b=$(this);b.hasClass("active")?b.removeClass("active"):b.addClass("active").siblings(".sort").removeClass("active");a.parseFilters()})},parseFilters:function(){for(var a=0,b;b=this.groups[a];a++)b.active=
b.$buttons.filter(".active").attr("data-sort")||"";this.concatenate()},concatenate:function(){this.outputString="";for(var a=0,b;b=this.groups[a];a++)this.outputString+=b.active;!this.outputString.length&&(this.outputString="all");console.log(this.outputString);this.$container.mixItUp("isLoaded")&&this.$container.mixItUp("sort",this.outputString)}}.init(),$("#mix-container").mixItUp({load:{sort:"abcsort:desc"},layout:{containerClass:"list"},controls:{enable:!1}}))}else $("#mix-container").html('<div class="slide"><span>No result!</span></div>')},
error:function(){$("#mix-container").html('<div class="slide"><strong>Error Loading Feed!</strong></div>')}})};
...
$(document).ready(function(){$("input#morphsearchInput").on("keyup",function(a){if(-1!==$.inArray(a.keyCode,[9,13,16,17,18,19,20,27,33,34,35,36,37,38,39,40]))return!1;clearTimeout($.data(this,"timer"));a=$(this).val().trim();$("#grid-gallery").html("");$("#advance-search-page").fadeOut().html("");""==a?($("#grid-gallery").fadeOut(),$("h4#results-text").fadeOut()):1<a.length&&($("#grid-gallery").fadeIn(),$("h4#results-text").fadeIn(),$(this).data("timer",setTimeout(function(){sgmSearch()},100)))});
$("#wrapselect select").change(function(a){clearTimeout($.data(this,"timer"));a=$("input#morphsearchInput").val().trim();$("#grid-gallery").html("");$("#advance-search-page").fadeOut().html("");$("input#morphsearchInput").focus();""==a?($("#grid-gallery").fadeOut(),$("h4#results-text").fadeOut()):1<a.length&&($("#grid-gallery").fadeIn(),$("h4#results-text").fadeIn(),$(this).data("timer",setTimeout(function(){sgmSearch()},100)))});$("#wrapselect input[type=checkbox]").change(function(a){clearTimeout($.data(this,
"timer"));a=$("input#morphsearchInput").val().trim();$("#grid-gallery").html("");$("#advance-search-page").fadeOut().html("");$("input#morphsearchInput").focus();""==a?($("#grid-gallery").fadeOut(),$("h4#results-text").fadeOut()):1<a.length&&($("#grid-gallery").fadeIn(),$("h4#results-text").fadeIn(),$(this).data("timer",setTimeout(function(){sgmSearch()},100)))});$(document).on("click","#advance-search-page span",function(a){a.preventDefault();var b=$(this).data("url-next");clearTimeout($.data(this,
"timer"));$(this).data("timer",setTimeout(function(){sgmSearch(b)},100))});getRecent("Bikini","#recentOverlay");getRecent("Sexy","#recentOverlay1",!0);$("#funbutton #trigger-overlay").click(function(){$(this).hasClass("wasLoaded")||(getListStar(),$(this).addClass("wasLoaded"))});var d=$("#menu-wrapper").offset().top,c=function(){$(window).scrollTop()>d?$("#menu-wrapper").css({position:"fixed",top:0,left:0,"z-index":99,background:"rgba(0, 0, 0, 0.6)"}):$("#menu-wrapper").css({position:"relative",background:""})};
c();$(window).scroll(function(){c()});$(".searchbutton").click(function(){$(this).toggleClass("active");$(".search-form").slideToggle("normal")});$(window).scroll(function(){100<$(this).scrollTop()?$("#BounceToTop").fadeIn():$("#BounceToTop").fadeOut()});$("#BounceToTop").click(function(){$("body, html").animate({scrollTop:0},600).animate({scrollTop:25},200).animate({scrollTop:0},150).animate({scrollTop:0},50)});var b=!1;$("#bt-show-hide-shoutbox").click(function(){b?$("#panel-shoutbox-bottom").stop(!0,
!0).animate({bottom:"-530px"},"fast"):$("#panel-shoutbox-bottom").stop(!0,!0).animate({bottom:"0"},"fast");b=!b});b||$("#close-shoutbox").click(function(){$("#panel-shoutbox-bottom").stop(!0,!0).animate({bottom:"-530px"},"fast")})});
