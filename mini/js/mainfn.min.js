...
function sgmTags(a,b){var d="["+a+"]",c="[/"+a+"]",e=b.indexOf(d)+(a.length+2);c=b.indexOf(c);var f="";-1!=b.indexOf(d)&&(f=b.substring(e,c));return f}function isImageOk(a){return!a.complete||"undefined"!=typeof a.naturalWidth&&0==a.naturalWidth?!1:!0}
function imageHostFix(a){return-1!=a.indexOf("googleusercontent.com")?a:a=-1!=a.indexOf("1.bp.blogspot.com")||-1!=a.indexOf("3.bp.blogspot.com")?a.replace(/[1|3]\.bp\.blogspot\.com/,"lh3.googleusercontent.com"):-1!=a.indexOf("2.bp.blogspot.com")||-1!=a.indexOf("4.bp.blogspot.com")?a.replace(/[2|4]\.bp\.blogspot\.com/,"lh4.googleusercontent.com"):"https://images1-focus-opensocial.googleusercontent.com/gadgets/proxy?container=focus&amp;refresh=31536000&amp;url="+encodeURIComponent(a)}
function resizeImg(a,b){if("w"in b&&""!=b.w||"h"in b&&""!=b.h||"s"in b&&""!=b.s){if(-1!=a.indexOf("googleusercontent.com")||-1!=a.indexOf("bp.blogspot.com")){var d="";var c="";var e="q"in b&&""!=b.q?"-l"+b.q:"-l90";"s"in b&&""!=b.s?c="s"+b.s+(""!=b.crop?"-"+b.crop:"")+e+"-e365":("w"in b&&""!=b.w&&(d="w"+b.w+"-"),"h"in b&&""!=b.h&&(c="h"+b.h+"-"),c=d+c+(""!=b.crop?b.crop:"")+e+"-e365");/\.[jpg|png|gif|jpeg]/i.test(a)?(d=a.split("/"),d.splice(d.length-2,1,c),c=d.join("/")):c=-1!=a.indexOf("=")?a.replace(/\=.*/g,
c):a+"="+c}else c=d="","s"in b&&""!=b.s?d=c=b.s:("w"in b&&""!=b.w&&(d="&resize_w="+b.w),"h"in b&&""!=b.h&&(c="&resize_h="+b.h)),c="https://images1-focus-opensocial.googleusercontent.com/gadgets/proxy?container=focus&refresh=31536000"+d+c+"&url="+encodeURIComponent(a);return c}return a}function getViewportSize(){var a=window,b=document,d=b.documentElement;b=b.getElementsByTagName("body")[0];return(a.innerWidth||d.clientWidth||b.clientWidth)+"x"+(a.innerHeight||d.clientHeight||b.clientHeight)}
$.fn.isOnScreen=function(){var a=$(window),b=a.scrollTop(),d=a.scrollLeft();var c=d+a.width();a=b+a.height();var e=this.offset();e.right=e.left+this.outerWidth();e.bottom=e.top+this.outerHeight();return!(c<e.left||d>e.right||a<e.top||b>e.bottom)};
function getAjax(a,b){if("undefined"!==typeof a.url&&""!==a.url&&null!==a.url){var d=0,c={alt:"json-in-script"},e={};"undefined"!==typeof a.beforeHandle&&$.isFunction(a.beforeHandle)||(a.beforeHandle=function(){});e="undefined"===typeof a.dataSend||"object"!==typeof a.dataSend||$.isEmptyObject(a.dataSend)?c:-1!=a.url.indexOf("blogspot.com")||-1!=a.url.indexOf("/feeds/")?$.extend({},c,a.dataSend):a.dataSend;$.ajax({url:a.url,type:"get",data:e,dataType:"jsonp",beforeSend:a.beforeHandle,success:function(a){b(a)},
error:function(){d++;3>d?getAjax(a,b):b("errFeed")}})}};