...
function sgmTags(a,b){var d="["+a+"]",e="[/"+a+"]",c=b.indexOf(d)+(a.length+2);e=b.indexOf(e);var f="";-1!=b.indexOf(d)&&(f=b.substring(c,e));return f}function isImageOk(a){return!a.complete||"undefined"!=typeof a.naturalWidth&&0==a.naturalWidth?!1:!0}
...
function getViewportSize(){var a=window,b=document,d=b.documentElement;b=b.getElementsByTagName("body")[0];return(a.innerWidth||d.clientWidth||b.clientWidth)+"x"+(a.innerHeight||d.clientHeight||b.clientHeight)}$.fn.isOnScreen=function(){var a=$(window),b=a.scrollTop(),d=a.scrollLeft();var e=d+a.width();a=b+a.height();var c=this.offset();c.right=c.left+this.outerWidth();c.bottom=c.top+this.outerHeight();return!(e<c.left||d>c.right||a<c.top||b>c.bottom)};
function getAjax(a,b){if("undefined"!==typeof a.url&&""!==a.url&&null!==a.url){var d=0,e={alt:"json-in-script"},c={};"undefined"!==typeof a.beforeHandle&&$.isFunction(a.beforeHandle)||(a.beforeHandle=function(){});c="undefined"===typeof a.dataSend||"object"!==typeof a.dataSend||$.isEmptyObject(a.dataSend)?e:-1!=a.url.indexOf("blogspot.com")||-1!=a.url.indexOf("/feeds/")?$.extend({},e,a.dataSend):a.dataSend;$.ajax({url:a.url,type:"get",data:c,dataType:"jsonp",beforeSend:a.beforeHandle,success:function(a){b(a)},
